#!/bin/bash
# 2026-08-06: seed-2 counterpart to run_sil_training_bi200_ss100_class1_legacy_fbv2.sh,
...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - feature_builder v2 seed2 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 2 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_fbv2_seed2" \
  > "sil_training_bi200_ss100_class1_legacy_fbv2_seed2.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 legacy feature_builder v2 seed2 (exit $?) ==="
