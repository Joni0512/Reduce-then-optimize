#!/bin/bash
# SIL (Structured Imitation Learning / COAML) + GNN pruner (v1_final), cardinality 3, threshold 0.5.
...
for inst in $INSTANCES; do
  echo ">>> coaml/v1final_c3_t05/${inst}"
  time python rtv_solver/main.py \
    ...
    --output_dir "new_tests/cardinality3_compare/bi400_ss100/coaml_v1final_t05/${inst}"
done

echo "=== COAML V1FINAL C3 T05 DONE (12/12) ==="
