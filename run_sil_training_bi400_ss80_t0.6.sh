#!/bin/bash
# 2026-07-18: SIL threshold 0.6 sweep, bi400/ss80 (t=0.5 already done).
...
run_variant() {
  ...
  echo "=== [$(date +%H:%M:%S)] SIL bi400/ss80 t=0.6: $variant ==="
  ./venv/bin/python3 rtv_solver/main.py \
    ...
    $pruner_flags \
    --seed 42 \
    --output_dir "outputs/sil_training_bi400_ss80_${variant}_t0.6" \
    > "sil_training_bi400_ss80_${variant}_t0.6.log" 2>&1
...
echo "=== ALL 3 SIL bi400/ss80 t=0.6 TRAINING RUNS DONE ==="
