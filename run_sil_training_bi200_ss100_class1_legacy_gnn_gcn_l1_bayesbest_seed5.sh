...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN GCN 1L Bayes-best seed 5 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 5 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_gcn_l1_bayesbest_seed5" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_gcn_l1_bayesbest_seed5.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: GCN 1L Bayes-best seed 5 (exit $?) ==="
