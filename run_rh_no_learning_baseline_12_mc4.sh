...
for INSTANCE in "${INSTANCES[@]}"; do
  ...
  echo "===== Running $INSTANCE | RH/offline no pruner | mc=4 ====="
  ...
  python3 -m rtv_solver.main \
    ...
    --batch_interval 400 \
    --step_size 100 \
    --output_dir "outputs/eval_rh_no_learning_baseline_mc4/${INSTANCE}"
done

echo "DONE RH/offline baseline evaluation (mc=4)"
