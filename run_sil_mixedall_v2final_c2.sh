#!/bin/bash
# SIL (Structured Imitation Learning / COAML) + GNN pruner (mixed_all, v2_final), cardinality 2, threshold 0.5.
set -u
...
for inst in $INSTANCES; do
  echo ">>> coaml/mixedall_v2final_c2_t05/${inst}"
  time python rtv_solver/main.py \
    ...
    --output_dir "new_tests/cardinality2_compare/bi400_ss100/coaml_mixedall_v2final_t05/${inst}"
done

echo "=== COAML MIXED_ALL V2FINAL C2 T05 DONE (12/12) ==="
