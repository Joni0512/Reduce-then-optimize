#!/bin/bash
# SIL (Structured Imitation Learning / COAML) baseline (no pruner), cardinality 2.
set -u

INSTANCES="lc108 lc109 lc207 lc208 lr111 lr112 lr210 lr211 lrc107 lrc108 lrc207 lrc208"

for inst in $INSTANCES; do
  echo ">>> coaml/baseline_c2/${inst}"
  time python rtv_solver/main.py \
    ...
    --output_dir "new_tests/cardinality2_compare/bi400_ss100/coaml_baseline/${inst}"
done

echo "=== COAML BASELINE C2 DONE (12/12) ==="
