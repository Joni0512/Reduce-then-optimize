...
for INSTANCE in "${INSTANCES[@]}"; do
  ...
  echo "===== Running $INSTANCE | RH/offline no pruner | mc=3 ====="
  ...
  python3 -m rtv_solver.main \
    ...
    --batch_interval 400 \
    --step_size 100 \
    --output_dir "outputs/eval_rh_no_learning_baseline_mc3/${INSTANCE}"
done

echo "DONE RH/offline baseline evaluation (mc=3)"
