#!/bin/bash
# RHO + GNN pruner (mixed_all, v2_final), cardinality 2, threshold 0.5.
set -u
...
for inst in $INSTANCES; do
  echo ">>> rh/mixedall_v2final_c2_t05/${inst}"
  time python rtv_solver/main.py \
    ...
    --output_dir "new_tests/cardinality2_compare/bi400_ss100/rh_mixedall_v2final_t05/${inst}"
done

echo "=== RH MIXED_ALL V2FINAL C2 T05 DONE (12/12) ==="
