#!/bin/bash
# 2026-08-01: GNN seed-variant run (1 message-passing layer, seed 1) for the
...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN 1L seed 1 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 1 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_l1_seed1" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_l1_seed1.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 legacy GNN 1L seed 1 (exit $?) ==="
