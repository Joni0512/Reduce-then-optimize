...
# dropout=0.0, seed 5. Testing whether the higher-learning-rate trend
...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN Pool 1L HP lr=0.001 h=64 do=0.0 seed5 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 5 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_pool_l1_hp_lr1e3_h64_d0_seed5" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_pool_l1_hp_lr1e3_h64_d0_seed5.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: Pool 1L HP lr=0.001 h=64 do=0.0 seed5 (exit $?) ==="
