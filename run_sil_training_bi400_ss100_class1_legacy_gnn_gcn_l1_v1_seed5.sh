...
echo "=== [$(date +%H:%M:%S)] SIL bi400/ss100 class1 legacy - GNN GCN 1L v1 (no pslack) seed5 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 5 \
  --output_dir "outputs/sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed5" \
  > "sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed5.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: GCN 1L v1 (no pslack) seed5 (exit $?) ==="
