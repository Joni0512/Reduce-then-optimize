...
# screening run, 1 message-passing layer, seed 2.
# Same setup as run_sil_training_bi200_ss100_class1_legacy_gnn_l1_seed2.sh,
...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN Concat 1L seed 2 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 2 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_concat_l1_seed2" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_concat_l1_seed2.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 legacy GNN Concat 1L seed 2 (exit $?) ==="
