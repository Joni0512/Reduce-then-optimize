...
class BusHandler:
    ...
    def first_bus_leave_time(self,bus_line,source,earliest_start_time):
        bus = self.busses[bus_line]
        travel_time = self.travel_time( bus_line, bus.stops[0], source)
    ...
    def bus_trips(self,bus_line,source_stop, destination_stop, ealiest_pick_up_time,latest_arrival_time):
        travel_time = self.travel_time( bus_line, source_stop, destination_stop)
        first_bus_leave_time = self.first_bus_leave_time(bus_line,source_stop,ealiest_pick_up_time)
        trips = []
    ...
    def bus_trips_with_transfer(self,bus_line1, bus_line2,source_stop, transfer_stop, destination_stop, ealiest_pick_up_time,latest_arrival_time):
        travel_time1 = self.travel_time( bus_line1, source_stop, transfer_stop)
        travel_time2 = self.travel_time( bus_line2, transfer_stop, destination_stop)
        latest_arrival_time_at_transfer = latest_arrival_time - self.get_time_delta(travel_time2)
        bus_leave_time_line1 = self.first_bus_leave_time(bus_line1,source_stop,ealiest_pick_up_time)
        trips = []
        ...
        while bus_arrival_time_at_transfer <= latest_arrival_time_at_transfer:
            bus_leave_time_line2 = self.first_bus_leave_time(bus_line2,transfer_stop,bus_arrival_time_at_transfer)
