...
class TripHandler:
    ...
    def generate_ondemand_only_trips(self,requests,current_time):
    ...
    def assign_trips_gurobi(self,vehicles,requests,request_bus_combinations,penalty,current_time):
