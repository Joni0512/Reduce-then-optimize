#!/bin/bash
# RHO + GNN pruner (mixed_all, v1_final), cardinality 3, threshold 0.5.
set -u
...
for inst in $INSTANCES; do
  echo ">>> rh/mixedall_v1final_c3_t05/${inst}"
  time python rtv_solver/main.py \
    ...
    --output_dir "new_tests/cardinality3_compare/bi400_ss100/rh_mixedall_v1final_t05/${inst}"
done

echo "=== RH MIXED_ALL V1FINAL C3 T05 DONE (12/12) ==="
