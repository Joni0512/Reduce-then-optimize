...
TEST_FILES = [
    # LR Holdout
    "lr110.json", "lr111.json", "lr112.json",
    # Big LR Holdouts
    "lr209.json", "lr210.json", "lr211.json",
]
...
OUTPUT_CSV = OUTPUT_DIR / "pruning_metrics_v2.csv"
OUTPUT_PNG = OUTPUT_DIR / "pruning_metrics_table_v2.png"
...
def save_table_as_png(df: pd.DataFrame, output_path: Path):
    ...
    display_df = display_df[
        [
            "instance", "threshold", "nodes", "edges_total",
            "positive_edges_total", "edges_kept", "positive_edges_kept",
            "positive_recall", "precision", "edge_reduction",
        ]
    ]
