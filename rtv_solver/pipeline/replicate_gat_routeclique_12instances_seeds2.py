"""
2026-09-06: SECOND batch of seeds (47-51) for the GAT-routeclique test - see
...
hyperparameters, same setup as replicate_gat_routeclique_12instances_seeds.py
...
def pretrain_shared_critic_seeded(seed: int) -> torch.nn.Module:
    ...
    output_dir = REPO_ROOT / "outputs" / "replicate_gat_routeclique_12instances_seeds2" / f"seed{seed}" / "critic_pretrain"
