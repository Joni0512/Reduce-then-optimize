...
but loops over all 5 seeds (43-47) sequentially in ONE job instead of 5
separate parallel jobs - see chat (fewer sbatch submissions requested).
Each seed takes ~3.5h (per the earlier seed43-46 bufferfix run), so 5
seeds sequentially fits comfortably inside the 24h time limit.
"""
import copy
import torch
...
if __name__ == "__main__":
    ...
    print(f"\n=== ALL {len(SEEDS)} SEEDS DONE (gat, local_positive, bufferfix) ===")
