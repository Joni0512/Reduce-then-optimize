...
ACTOR_CHECKPOINT = str(list((REPO_ROOT / "outputs/outputs/sil_training_bi400_ss100_mixed_legacy_mlp_seed1").rglob("coaml_model_weights_best_val.pt"))[0])
...
if __name__ == "__main__":
    ...
    for instance in TEST_INSTANCES:
        print(f"\n=== {instance} (frozen shared critic, bi=400) ===")
        try:
            train(
                instance=instance,
                episodes=EPISODES,
