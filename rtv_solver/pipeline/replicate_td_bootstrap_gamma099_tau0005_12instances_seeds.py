"""
2026-09-09: replicates the 12-instance TD-bootstrap critic target
(gamma=0.99, tau=0.005) result across 4 additional seeds (43-46), on top of
the local seed=42 run (run_srl_balanced_td_bootstrap_gamma099_tau0005_12instances.py)
- see chat. Same pattern as the other seed-replication scripts: checks
whether the seed=42 pattern (instance-specific collapse on lrc207, stable
elsewhere) is robust or a seed=42 artifact.
"""
