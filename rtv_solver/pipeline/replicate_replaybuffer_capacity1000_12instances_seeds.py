"""
2026-09-05: replicates the 12-instance replay_capacity=1000 (no target_critic)
...
checks whether capacity=1000's seed=42 result (mean final SR 0.484, below
capacity=40's 0.580) is robust or a seed=42 artifact - notably lrc207 showed
0.000 here despite an earlier single-instance test showing 0.333 improvement.
"""
...
def pretrain_shared_critic_seeded(seed: int) -> torch.nn.Module:
    ...
    output_dir = REPO_ROOT / "outputs" / "replicate_replaybuffer_capacity1000_12instances_seeds" / f"seed{seed}" / "critic_pretrain"
...
if __name__ == "__main__":
    for seed in NEW_SEEDS:
        ...
        for instance in TEST_INSTANCES:
            print(f"=== seed={seed} instance={instance} (balanced, replay_capacity=1000) ===")
            try:
                ...
                train(
                    ...
                    label_suffix=f"_balanced_replaybuffer_capacity1000_seed{seed}",
