...
# screening run, 2 message-passing layers, seed 3.
# Same setup as run_sil_training_bi200_ss100_class1_legacy_gnn_l2_seed3.sh,
...
echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN Concat 2L seed 3 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 3 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_concat_l2_seed3" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_concat_l2_seed3.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 legacy GNN Concat 2L seed 3 (exit $?) ==="
