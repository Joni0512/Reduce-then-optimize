...
echo "=== [$(date +%H:%M:%S)] SIL bi400/ss100 class1 legacy - GNN GCN 1L v1 (no pslack) seed1 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 1 \
  --output_dir "outputs/sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed1" \
  > "sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed1.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: GCN 1L v1 (no pslack) seed1 (exit $?) ==="
