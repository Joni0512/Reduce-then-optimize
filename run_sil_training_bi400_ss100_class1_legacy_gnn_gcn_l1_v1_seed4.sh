...
echo "=== [$(date +%H:%M:%S)] SIL bi400/ss100 class1 legacy - GNN GCN 1L v1 (no pslack) seed4 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 4 \
  --output_dir "outputs/sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed4" \
  > "sil_training_bi400_ss100_class1_legacy_gnn_gcn_l1_v1_seed4.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: GCN 1L v1 (no pslack) seed4 (exit $?) ==="
