...
# passing layers, seed 4.
set -eu

echo "=== [$(date +%H:%M:%S)] SIL bi200/ss100 class1 legacy - GNN Pool 2L seed 4 ==="
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 4 \
  --output_dir "outputs/sil_training_bi200_ss100_class1_legacy_gnn_pool_l2_seed4" \
  > "sil_training_bi200_ss100_class1_legacy_gnn_pool_l2_seed4.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 legacy GNN Pool 2L seed 4 (exit $?) ==="
