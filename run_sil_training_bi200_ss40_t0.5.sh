#!/bin/bash
# 2026-07-17: SIL sweep at bi200/ss40 (ratio 5:1, small horizon) - completes
# the 2x2 horizon x ratio grid alongside bi200/ss100, bi400/ss200, bi400/ss80.
# Threshold 0.5, seed 42, 4 variants sequentially.
set -u

REQUEST_PRUNER_MODEL_DIR="outputs/request_pruner_mlp_bi200_ss40"
...
run_variant() {
  ...
  echo "=== [$(date +%H:%M:%S)] SIL bi200/ss40 t=0.5: $variant ==="
  ./venv/bin/python3 rtv_solver/main.py \
    ...
    $pruner_flags \
    --seed $SEED \
    --output_dir "outputs/sil_training_bi200_ss40_${variant}_t0.5" \
    > "/tmp/sil_training_bi200_ss40_${variant}_t0.5.log" 2>&1
...
echo "=== ALL 4 SIL bi200/ss40 t=0.5 RUNS DONE ==="
