...
./venv/bin/python3 rtv_solver/main.py \
  ...
  --seed 1 \
  --output_dir "outputs/sil_training_bi200_ss50_class1_exp_prefix_seed1" \
  > "sil_training_bi200_ss50_class1_exp_prefix_seed1.log" 2>&1
echo "=== [$(date +%H:%M:%S)] DONE: class1 exp_prefix bi200/ss50 seed1 (exit $?) ==="
