#!/bin/bash
# 2026-07-18: SIL threshold 0.4 sweep, bi200/ss40 - completes the 0.4/0.5/0.6
# threshold set for this config (t=0.5 already done, t=0.6 done alongside
# this). Skips baseline (threshold-independent, reused from the t=0.5 run).
set -u
...
echo "=== ALL 3 SIL bi200/ss40 t=0.4 TRAINING RUNS DONE ==="
