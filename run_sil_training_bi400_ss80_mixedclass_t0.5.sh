#!/bin/bash
# 2026-07-20: mixed-class SIL sweep at bi400/ss80, t=0.5 - same setup as
...
run_variant() {
  ...
  echo "=== [$(date +%H:%M:%S)] SIL bi400/ss80 mixedclass t=0.5: $variant ==="
  ./venv/bin/python3 rtv_solver/main.py \
    ...
    $pruner_flags \
    --seed 42 \
    --output_dir "outputs/sil_training_bi400_ss80_mixedclass_${variant}_t0.5" \
    > "sil_training_bi400_ss80_mixedclass_${variant}_t0.5.log" 2>&1
...
echo "=== ALL 4 SIL bi400/ss80 mixedclass t=0.5 RUNS DONE ==="
